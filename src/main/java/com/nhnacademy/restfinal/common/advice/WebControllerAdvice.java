package com.nhnacademy.restfinal.common.advice;

import com.nhnacademy.restfinal.exception.DuplicateResourceException;
...
public class WebControllerAdvice {
    ...
    @ExceptionHandler(TTLMemberException.class)
    public ResponseEntity<String> TTLMemberException(Exception ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ex.getMessage());
    }
